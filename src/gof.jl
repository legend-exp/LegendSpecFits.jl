...
"""
    _get_model_counts(f_fit::Base.Callable, v_ml::NamedTuple, bin_centers::Union{StepRangeLen, Vector{<:Real}}, bin_widths::Union{StepRangeLen, Vector{<:Real}})
...
""" 
    p_value(fit_func::Base.Callable, h::Histogram{<:Real,1}, v_ml::NamedTuple) 
...
""" 
    p_value_poissonll(fit_func::Base.Callable, h::Histogram{<:Real,1}, v_ml::NamedTuple)
...
TO DO: add description of function.
"""
...
""" 
    get_residuals(f_fit::Base.Callable, h::Histogram{<:Real,1},v_ml::NamedTuple)
