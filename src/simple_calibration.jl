...
"""
function simple_calibration(e_uncal::Array{T}, th228_lines::Array{T}, window_sizes::Array{T}; n_bins::Int=15000, quantile_perc::Float64=0.995, calib_type::Symbol=:th228) where T<:Real
    if calib_type == :th228
...
function simple_calibration_th228(e_uncal::Array{T}, th228_lines::Array{T}, window_sizes::Array{T}; n_bins::Int=15000, quantile_perc::Float64=0.995) where T<:Real
