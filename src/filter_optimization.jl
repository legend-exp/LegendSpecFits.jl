...
"""
function fit_sf_wl(dep_sep_data::NamedTuple{(:dep, :sep)}, a_grid_wl_sg::StepRangeLen, optimization_config::PropDict; uncertainty::Bool = false)
    # unpack config
    ...
    dep_cut_search_fit_func = Symbol(optimization_config.dep_cut_search_fit_func)
    sep_cut_search_fit_func = Symbol(optimization_config.sep_cut_search_fit_func)
